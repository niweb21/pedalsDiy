...
void drawVerticalLoader(int x, int y, int value)
{
  ...
  // left line
  display.drawLine(x + 00, y + 00, x + 00, y + 58, SSD1306_WHITE);
  display.drawLine(x + 01, y + 00, x + 01, y + 58, SSD1306_WHITE);

  // right line
  display.drawLine(x + 09, y + 00, x + 10, y + 58, SSD1306_WHITE); // @TODO need to fix or ok ?

  // upper line
  display.drawLine(x + 02, y + 00, x + 08, y + 00, SSD1306_WHITE);
  display.drawLine(x + 02, y + 01, x + 08, y + 01, SSD1306_WHITE);

  // lower line
  display.drawLine(x + 02, y + 57, x + 08, y + 57, SSD1306_WHITE);
  display.drawLine(x + 02, y + 58, x + 08, y + 58, SSD1306_WHITE);
